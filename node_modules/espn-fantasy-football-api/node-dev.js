...
/* harmony import */ var _boxscore_boxscore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../boxscore/boxscore */ "./src/boxscore/boxscore.js");
...
axios__WEBPACK_IMPORTED_MODULE_9__["default"].defaults.baseURL = 'https://fantasy.espn.com/apis/v3/games/ffl/seasons/';
...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    ...
    value: function getBoxscoreForWeek(_ref2) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(data, function (matchup) {
          return _boxscore_boxscore__WEBPACK_IMPORTED_MODULE_4__["default"].buildFromServer(matchup, {
    ...
    value: function getHistoricalScoreboardForWeek(_ref3) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, axiosConfig).then(function (response) {
    ...
    value: function getFreeAgents(_ref4) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, config).then(function (response) {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(data, function (player) {
          return _free_agent_player_free_agent_player__WEBPACK_IMPORTED_MODULE_5__["default"].buildFromServer(player, {
    ...
    value: function getTeamsAtWeek(_ref5) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(data, function (team) {
          return _team_team__WEBPACK_IMPORTED_MODULE_8__["default"].buildFromServer(team, {
    ...
    value: function getNFLGamesForPeriod(_ref6) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, axiosConfig).then(function (response) {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(data, function (game) {
          return _nfl_game_nfl_game__WEBPACK_IMPORTED_MODULE_7__["default"].buildFromServer(game);
        });
      });
    }
    ...
    value: function getLeagueInfo(_ref7) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_9__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        ...
        return _league_league__WEBPACK_IMPORTED_MODULE_6__["default"].buildFromServer(data, {
