...
var BaseObject = /*#__PURE__*/function () {
  ...
  _createClass(BaseObject, null, [{
    ...
    value: function buildFromServer(data, constructorParams) {
      ...
      var dataToUse = this.flattenResponse ? (0,_utils_js__WEBPACK_IMPORTED_MODULE_9__.flattenObject)(data) : data;
...
axios__WEBPACK_IMPORTED_MODULE_11__["default"].defaults.baseURL = 'https://fantasy.espn.com/apis/v3/games/ffl/seasons/';
...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    ...
    value: function getBoxscoreForWeek(_ref2) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
    ...
    value: function getDraftInfo(_ref3) {
      ...
      var playerRoute = this.constructor._buildRoute({
        base: "".concat(seasonId, "/segments/0/leagues/").concat(this.leagueId),
        params: "?scoringPeriodId=".concat(scoringPeriodId, "&view=players_wl")
      });
      return Promise.all([axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(draftRoute, this._buildAxiosConfig()), axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(playerRoute, this._buildAxiosConfig({
        headers: {
        ...
        return lodash_map__WEBPACK_IMPORTED_MODULE_2___default()(draftResponse.data.draftDetail.picks, function (draftPick) {
          ...
          var data = _objectSpread(_objectSpread({}, draftPick), playerInfo.player);
    ...
    value: function getHistoricalScoreboardForWeek(_ref6) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(route, axiosConfig).then(function (response) {
    ...
    value: function getFreeAgents(_ref7) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(route, config).then(function (response) {
    ...
    value: function getTeamsAtWeek(_ref8) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(route, this._buildAxiosConfig()).then(function (response) {
        return _this4._parseTeamReponse(response.data, seasonId);
      });
    }
    ...
    value: function getHistoricalTeamsAtWeek(_ref9) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11__["default"].get(route, axiosConfig).then(function (response) {
        return (
          ...
          _this5._parseTeamReponse(response.data[0], seasonId)
        );
      });
    }
  }, {
    key: "_parseTeamReponse",
    value: function _parseTeamReponse(responseData, seasonId) {
      var _this6 = this;
...
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/get */ "./node_modules/lodash/get.js");
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _base_classes_base_cacheable_object_base_cacheable_object__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../base-classes/base-cacheable-object/base-cacheable-object */ "./src/base-classes/base-cacheable-object/base-cacheable-object.js");
 ...
 */
var DraftPlayer = /*#__PURE__*/function (_BaseCacheableObject) {
  _inherits(DraftPlayer, _BaseCacheableObject);
  ...
  return DraftPlayer;
}(_base_classes_base_cacheable_object_base_cacheable_object__WEBPACK_IMPORTED_MODULE_2__["default"]);
_defineProperty(DraftPlayer, "displayName", 'DraftPlayer');
_defineProperty(DraftPlayer, "responseMap", {
  id: 'playerId',
  name: 'fullName',
  teamId: 'teamId',
  proTeam: {
    key: 'proTeamId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_3__.nflTeamIdToNFLTeam, responseData);
    }
  },
  proTeamAbbreviation: {
    key: 'proTeamId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_3__.nflTeamIdToNFLTeamAbbreviation, responseData);
    }
  },
  defaultPosition: {
    key: 'defaultPositionId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_3__.slotCategoryIdToPositionMap, responseData);
    }
  },
  eligiblePositions: {
    key: 'eligibleSlots',
    manualParse: function manualParse(responseData) {
      return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(responseData, function (posId) {
        return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_3__.slotCategoryIdToPositionMap, posId);
      });
    }
  },
...
/* harmony import */ var _platform_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../platform/index.js */ "./node_modules/axios/lib/platform/node/index.js");
...
/* harmony export */   FreeAgentPlayer: () => (/* reexport safe */ _free_agent_player_free_agent_player__WEBPACK_IMPORTED_MODULE_3__["default"]),
/* harmony export */   Player: () => (/* reexport safe */ _player_player__WEBPACK_IMPORTED_MODULE_4__["default"]),
/* harmony export */   PlayerStats: () => (/* reexport safe */ _player_stats_player_stats__WEBPACK_IMPORTED_MODULE_5__["default"]),
/* harmony export */   Team: () => (/* reexport safe */ _team_team__WEBPACK_IMPORTED_MODULE_6__["default"])
/* harmony export */ });
